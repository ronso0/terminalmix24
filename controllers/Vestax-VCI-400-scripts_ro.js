...
VestaxVCI400.init = function (id) {
   ...
   // Activate hotcue mode
   // Bug: MODE LEDs don't work
   // VestaxVCI400.Decks.A.setButtonMode(VestaxVCI400.ModeEnum.HOTCUE);
   // VestaxVCI400.Decks.B.setButtonMode(VestaxVCI400.ModeEnum.HOTCUE);
   // VestaxVCI400.Decks.C.setButtonMode(VestaxVCI400.ModeEnum.HOTCUE);
   // VestaxVCI400.Decks.C.setButtonMode(VestaxVCI400.ModeEnum.HOTCUE);
...
VestaxVCI400.Deck.prototype.init = function() {
    ...
    // engine.makeConnection("[Sampler1]","track_loaded", "VestaxVCI400.Decks."+this.deckIdentifier+".onSampler1DurationChanged");
    // engine.makeConnection("[Sampler2]","track_loaded", "VestaxVCI400.Decks."+this.deckIdentifier+".onSampler2DurationChanged");
    // engine.makeConnection("[Sampler3]","track_loaded", "VestaxVCI400.Decks."+this.deckIdentifier+".onSampler3DurationChanged");
    // engine.makeConnection("[Sampler4]","track_loaded", "VestaxVCI400.Decks."+this.deckIdentifier+".onSampler4DurationChanged");
...
// New mapping of FX units using midi-components-0.0_2.3_ronso0.js
...
//  * shows/hides Fx focus selectors in colapsed units
// VestaxVCI400.effectUnit13 = new components.EffectUnit([1,3],true);
VestaxVCI400.effectUnit13 = new components.EffectUnit([1,3],false);
VestaxVCI400.effectUnit13.enableButtons[1].midi = [0x9C, 0x01];
VestaxVCI400.effectUnit13.enableButtons[2].midi = [0x9C, 0x02];
VestaxVCI400.effectUnit13.enableButtons[3].midi = [0x9C, 0x03];
VestaxVCI400.effectUnit13.knobs[1].midi = [0xBC, 0x01];
VestaxVCI400.effectUnit13.knobs[2].midi = [0xBC, 0x02];
VestaxVCI400.effectUnit13.knobs[3].midi = [0xBC, 0x03];
VestaxVCI400.effectUnit13.dryWetKnob.midi = [0xBC, 0x2B];
VestaxVCI400.effectUnit13.effectFocusButton.midi = [0x9C, 0x04];
VestaxVCI400.effectUnit13.init();

// EffectUnits 2/4
VestaxVCI400.effectUnit24 = new components.EffectUnit([2,4],true);
VestaxVCI400.effectUnit24.enableButtons[1].midi = [0x9D, 0x01];
VestaxVCI400.effectUnit24.enableButtons[2].midi = [0x9D, 0x02];
VestaxVCI400.effectUnit24.enableButtons[3].midi = [0x9D, 0x03];
VestaxVCI400.effectUnit24.knobs[1].midi = [0xBD, 0x01];
VestaxVCI400.effectUnit24.knobs[2].midi = [0xBD, 0x02];
VestaxVCI400.effectUnit24.knobs[3].midi = [0xBD, 0x03];
VestaxVCI400.effectUnit24.dryWetKnob.midi = [0xBD, 0x2B];
VestaxVCI400.effectUnit24.effectFocusButton.midi = [0x9D, 0x04];
VestaxVCI400.effectUnit24.init();
...
VestaxVCI400.Deck.prototype.setButtonMode = function(value) {
    ...
    case VestaxVCI400.ModeEnum.ROLL:
        ...
        break;
    case VestaxVCI400.ModeEnum.SAMPLER:
        this.onSampler1DurationChanged(engine.getValue("[Sampler1]", "track_loaded"), this.group);
        this.onSampler2DurationChanged(engine.getValue("[Sampler2]", "track_loaded"), this.group);
        this.onSampler3DurationChanged(engine.getValue("[Sampler3]", "track_loaded"), this.group);
        this.onSampler4DurationChanged(engine.getValue("[Sampler4]", "track_loaded"), this.group);
